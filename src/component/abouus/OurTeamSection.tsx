...
const LEADERS: Leader[] = [
    {
        ...
        title: "Founder & CEO",
        image:
            "https://truesun.in/wp-content/uploads/2022/02/2-1.png",
    ...
    },
    {
        ...
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTabOgeMNrSqYJ4c2-kMg0I_QreIqbVVfgvWQ&s",
...
// Reusable subtle fade-up for small headers/paragraphs
const fadeUpProps = {
...
// Staggered container for lists like accordions
    ...
    return (
        ...
        >
            ...
            >
                ...
                <span
                    className={`inline-flex h-6 w-6 items-center justify-center rounded-full ring-1 ring-neutral-300 transition-transform ${open ? "rotate-45" : ""
                        }`}
                    aria-hidden
                >
            ...
            <div
                className={`grid overflow-hidden px-5 transition-all duration-300 ease-in-out ${open ? "grid-rows-[1fr] pb-5" : "grid-rows-[0fr]"
                    }`}
            >
        ...
        <div className="bg-linear-to-br from-white via-amber-50/50 to-emerald-50/50 py-16">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <motion.div
                    ...
                    whileInView="show"
                    viewport={{ once: true }}
                    className="divide-y divide-gray-200 overflow-hidden rounded-2xl border border-gray-800/20 bg-white"
                >
                    {faqs.map((f, i) => (
    ...
    return (
        <section className="relative overflow-hidden bg-linear-to-b from-white via-amber-50/20 to-white py-10 sm:py-14">
            ...
            <div className="pointer-events-none absolute inset-0 -z-10">
                <motion.div
                    aria-hidden
                    className="absolute left-1/2 top-[22%] h:[680px] w:[680px] -translate-x-1/2 rounded-full blur-3xl md:h-[680px] md:w-[680px]"
                    style={{
                        background:
            ...
            <div className="mx-auto max-w-3xl px-6 text-center">
                ...
                <p className="mt-4 text-lg text-neutral-600">
                    A seasoned group shaping renewable energy with financial rigor,
                    technical depth, and delivery excellence.
                </p>
            </div>
            ...
            >
                {LEADERS.map((m) => (
                    <motion.article
                        ...
                        className="group relative overflow-hidden rounded-2xl bg-white shadow-2xl shadow-black/50 ring-2 ring-amber-600/30 transition-all"
                    >
